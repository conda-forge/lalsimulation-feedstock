...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lalsimulation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lalsimulation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lalsimulation lalsimulation-data liblalsimulation python-lalsimulation
# for installing globally
pixi global install lalsimulation lalsimulation-data liblalsimulation python-lalsimulation
```
...
It is possible to list all of the versions of `lalsimulation` available on your platform:
...
```
pixi search lalsimulation --channel conda-forge
```
